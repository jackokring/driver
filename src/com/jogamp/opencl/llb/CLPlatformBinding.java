/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Fri Aug 03 06:57:09 CEST 2012 ----! */
...
public interface CLPlatformBinding {
  ...
  /** Interface to C language function: <br> <code> cl_int {@native clGetDeviceIDs}(cl_platform_id platform, cl_device_type device_type, cl_uint num_entries, cl_device_id *  devices, cl_uint *  num_devices); </code> 
  ...
  /** Interface to C language function: <br> <code> cl_int {@native clGetPlatformIDs}(cl_uint num_entries, cl_platform_id *  platforms, cl_uint *  num_platforms); </code> 
  ...
  /** Interface to C language function: <br> <code> cl_int {@native clGetPlatformInfo}(cl_platform_id platform, cl_platform_info param_name, size_t param_value_size, void *  param_value, size_t *  param_value_size_ret); </code> 
  ...
  /** Interface to C language function: <br> <code> cl_int {@native clIcdGetPlatformIDsKHR}(cl_uint, cl_platform_id * , cl_uint * ); </code> 
